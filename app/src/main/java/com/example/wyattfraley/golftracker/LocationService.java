...
public class LocationService extends AppCompatActivity {
    // Establish update intervals
    private String LastUpdate;
    private static final long UpdateInterval = 2000;
    private static final long FastestUpdateInterval = 500;
    ...
    private void updateLocationUI() {
        // Here we update the player's location and relationship to important
        // landmarks like bunkers and greens.
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(LocationService.this, 100);
